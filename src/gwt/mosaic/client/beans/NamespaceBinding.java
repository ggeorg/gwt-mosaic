...
public class NamespaceBinding {
	...
	public NamespaceBinding(Map<String, Object> namespace, String sourcePath,
		...
		if (!targetMap.containsKey(targetKey)) {
			throw new IllegalArgumentException("Target property \""
	...
	public void bind() {
		if (source instanceof Map<?, ?>) {
			if (source instanceof ObservableMap<?, ?>) {
				bindHR = ((ObservableMap<String, Object>) sourceMap)
						.addKeyValueUpdateHandler(sourceMapHandler);
			}
		} else {
			bindHR = sourceMonitor
					.addPropertyChangeHandler(sourcePropertyChangeHandler);
		}
	}
