...
public class Label extends Component {
	...
	private static class LabelBindingListenerList extends
			ListenerList<LabelBindingListener> implements LabelBindingListener {
		@Override
	...
	public void setTextBindType(BindType textBindType) {
		...
		if (previousTextBindType != textBindType) {
			...
			labelBindingListeners.textBindTypeChanged(this,
	...
	public void setTextBindMapping(TextBindMapping textBindMapping) {
		...
		if (previousTextBindMapping != textBindMapping) {
			...
			labelBindingListeners.textBindMappingChanged(this,
