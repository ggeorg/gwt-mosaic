...
import gwt.mosaic.client.wtk.FlowPane;
 ...
 * Flow pane skin.
 */
public class FlowPaneSkin extends PanelSkin {
	...
	public Dimensions getPreferredSize() {
		...
		return new Dimensions(preferredWidth, ascent + descent + padding.top
				+ padding.bottom);
	}
	...
	public void layout() {
		...
		for (int i = 0, n = rows.getLength(); i < n; i++) {
			...
			for (Component component : row) {
				...
				baseline = Math.max(
						baseline,
						component.getBaseline(component.getWidth(),
								component.getHeight()));
			}
