...
public abstract class Action {
	...
	public static final class NamedActionDictionary implements
			Dictionary<String, Action>, Iterable<String> {
	...
	private static class ActionListenerList extends
			ListenerList<ActionListener> implements ActionListener {
		@Override
	...
	private static class ActionClassListenerList extends
			ListenerList<ActionClassListener> implements ActionClassListener {
		@Override
