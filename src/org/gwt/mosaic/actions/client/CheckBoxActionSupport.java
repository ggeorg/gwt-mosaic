 ...
 */
public class CheckBoxActionSupport extends ButtonBaseActionSupport {
  ...
  public CheckBoxActionSupport(Action source) {
    this(source, new CheckBox());
  }

  public CheckBoxActionSupport(Action source, CheckBox target) {
    super(source, target);
