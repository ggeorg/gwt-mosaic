...
import org.gwt.mosaic.ui.client.table.FixedWidthTableImpl.IdealColumnWidthInfo;
...
public class FixedWidthGrid extends SortableGrid {
  ...
  public class FixedWidthGridRowFormatter extends SelectionGridRowFormatter {
    @Override
    public Element getRawElement(int row) {
   ...
   * @return the {@link FixedWidthGrid}'s cell formatter
   */
  public FixedWidthGridRowFormatter getFixedWidthGridRowFormatter() {
