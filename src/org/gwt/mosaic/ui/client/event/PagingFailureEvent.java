...
public class PagingFailureEvent extends GwtEvent<PagingFailureHandler> {
  ...
  /**
   * Fires a page failure event on all registered handlers in the handler manager.
   * 
   * @param <S> The event source
   * @param source the source of the handlers
   */
  public static <S extends PagingFailureHandler & HasHandlers> void fire(
      S source, Exception exception) {
    if (TYPE != null) {
