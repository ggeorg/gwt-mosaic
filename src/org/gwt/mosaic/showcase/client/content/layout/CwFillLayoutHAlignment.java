...
public class CwFillLayoutHAlignment extends ContentWidget {
   ...
   */
  public CwFillLayoutHAlignment(CwConstants constants) {
    super(constants);
  }

  @Override
  public String getDescription() {
    return "The FillLayout with a horizontal alignment.";
  }
