...
import org.mosaic.ui.client.scrolltable.AbstractCellEditor.CellEditInfo;
import org.mosaic.ui.client.scrolltable.SortableGrid.ColumnSorter;
import org.mosaic.ui.client.scrolltable.SortableGrid.ColumnSorterCallback;
import org.mosaic.ui.client.scrolltable.TableModel.Callback;
...
import org.mosaic.ui.client.scrolltable.TableModel.Response;
...
public class PagingScrollTable<R> extends ScrollTable implements SourceRowPagingEvents {
   ...
   */
  private static class VisibleRowsIterator implements Iterator<Iterator<Object>> {
    /**
   ...
   */
  protected void setData(int firstRow, Iterator<Iterator<Object>> rows, List<R> rowValues) {
    this.rowValues = rowValues;
    if (rows != null) {
      // Get an iterator over the visible rows
      int firstVisibleRow = getFirstRow();
      int lastVisibleRow = getLastRow();
      Iterator<Iterator<Object>> visibleIter = new VisibleRowsIterator(rows, firstRow,
