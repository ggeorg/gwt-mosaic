...
public class PickupDragController extends AbstractDragController {
   ...
   *            <code>RootPanel.get()</code> if entire document body is to be
   *            the boundary
  ...
  protected Widget newDragProxy(DragContext context) {
    ...
    WidgetArea draggableArea = new WidgetArea(context.draggable, null, false);
    for (Widget widget : context.selectedWidgets) {
      WidgetArea widgetArea = new WidgetArea(widget, null, false);
  ...
  private DropController getIntersectDropController(int x, int y) {
    DropController dropController = dropControllerCollection.getIntersectDropController(
        x, y);
