...
public class Canvas {
	 ...
	 * 
	 * <p>
	 * Screen size of canvas in pixels defaults to whatever was configured for
	 * the canvas element we are adopting.
	 * </p>
	 * 
	 * @param element
	 *            the externally created canvas element
	 */
	 ...
	 *            the size of the coordinate space in the y direction
	 * @param pixelX
	 *            the CSS width in pixels of the canvas element
	 * @param pixelY
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).arc(x,y,radius,startAngle,endAngle,antiClockwise);
	}-*/;
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).beginPath();
	}-*/;
	...
	public native void clearRect(double startX, double startY, double width,
			double height)
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).clearRect(startX,startY,width,height);
	}-*/;
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).clip();
	}-*/;
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).closePath();
	}-*/;
	 ...
	 * 
	 * @param x0
	 *            x coord of start point of gradient
	 * @param y0
	 *            y coord of start point of gradient
	 * @param x1
	 *            x coord of end point of gradient
	 * @param y1
	 *            y coord of end point of gradient
	 ...
	 * 
	 * @param x0
	 *            x coord of origin of start circle
	 * @param y0
	 *            y coord of origin of start circle
	 * @param r0
	 *            radius of start circle
	 * @param x1
	 *            x coord of origin of end circle
	 * @param y1
	 *            y coord of origin of end circle
	 * @param r1
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).bezierCurveTo(cp1x,cp1y,cp2x,cp2y,x,y);
	}-*/;
	 ...
	 *            y coord of the top left corner in the destination space
	 * @param width
	 *            the size of the image in the destination space
	 * @param height
	 *            the size of the image in the destination space
	 */
	public void drawImage(ImageHandle img, double offsetX, double offsetY,
	...
	public native void drawImage(ImageHandle img, double sourceX,
			double sourceY, double sourceWidth, double sourceHeight,
			double destX, double destY, double destWidth, double destHeight)
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).drawImage(img,sourceX,sourceY,sourceWidth,sourceHeight,destX,destY,destWidth,destHeight);
	}-*/;
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).fill();
	}-*/;
	...
	public native void fillRect(double startX, double startY, double width,
			double height)
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).fillRect(startX,startY,width,height);
	}-*/;
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).lineTo(x,y);
	}-*/;
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).moveTo(x,y);
	}-*/;
	...
	public native void quadraticCurveTo(double cpx, double cpy, double x,
			double y)
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).quadraticCurveTo(cpx,cpy,x,y);
	}-*/;
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).rect(x,y,width,height);
	}-*/;

	/**
	 * Convenience function for resizing the canvas with consistent coordinate
	 * and screen pixel spaces. Equivalent to doing:
	 * 
	 * <pre>
	 * <code>
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).restore();
	}-*/;
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).rotate(angle);
	}-*/;
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).save();
	}-*/;
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).scale(x,y);
	}-*/;
	 ...
	 * 
	 * @param width
	 *            the size of the x component of the coordinate space
	 * @param height
	 *            the size of the y component of the coordinate space
	 */
	...
	/*-{
	  var gradObj = gradient.@org.gwt.mosaic2.client.graphics.CanvasGradient::getObject()();
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).fillStyle = gradObj;
	}-*/;
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).globalAlpha = alpha;
	}-*/;
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).lineWidth = width;
	}-*/;
	...
	/*-{
	  var gradObj = gradient.@org.gwt.mosaic2.client.graphics.CanvasGradient::getObject()();
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).strokeStyle = gradObj;
	}-*/;
	 ...
	 * 
	 * @param styleString
	 *            String representing the stroke style
	 */
	public native void setStrokeStyle(String styleString)
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).strokeStyle = styleString;
	}-*/;
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).stroke();
	}-*/;
	...
	public native void strokeRect(double startX, double startY, double width,
			double height)
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).strokeRect(startX,startY,width,height);
	}-*/;
	 ...
	 */
	public native void transform(double m11, double m12, double m21,
			double m22, double dx, double dy)
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).transform(m11,m12,m21,m22,dx,dy);
	}-*/;
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).translate(x,y);
	}-*/;
	...
	/*-{
	  (this.@org.gwt.mosaic2.client.graphics.Canvas::canvasContext).fillStyle = colorStr;
	}-*/;

	private native void setGfxContext(Element e)
	/*-{
	  this.@org.gwt.mosaic2.client.graphics.Canvas::setCanvasContext(Lcom/google/gwt/core/client/JavaScriptObject;)(e.getContext('2d'));
	}-*/;
