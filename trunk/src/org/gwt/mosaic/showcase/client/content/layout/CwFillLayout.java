...
public class CwFillLayout extends ContentWidget {
  ...
  protected Widget onInitialize() {
    ...
    final CaptionLayoutPanel captionLayoutPanel = new CaptionLayoutPanel("Meteora (Greece)");
    layoutPanel.add(captionLayoutPanel, new FillLayoutData(true));
    captionLayoutPanel.getHeader().add(Showcase.IMAGES.gwtLogoThumb().createImage());

    final Image img = new Image("MeteoraGreece.JPG");
    captionLayoutPanel.add(img);
