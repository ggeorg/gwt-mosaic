...
import org.gwt.mosaic.ui.client.layout.FormLayout;
...
public class CwComplexForm extends ContentWidget {
  ...
  private Widget createForm1() {
    ...
    final LayoutPanel formLayout = new LayoutPanel(new FormLayout(
        new double[] {-1.0, -2.0, -2.0, 5.0, -1.0, -2.0, -2.0}, new double[] {
  ...
  private Widget createForm2() {
    ...
    builder.addSeparator("Description", 7);

    // row #2

    builder.add(new TextArea(), new GridLayoutData(5, 2));
    builder.add(new CheckBox("Done"), new GridLayoutData(2, 2));

    // row #3

    builder.addSeparator("Date / Time", 3);
    builder.addGap();
    builder.addSeparator("Attributes", 3);
    ...
    builder.addLabel("Start Date:", 1);
    builder.add(startDate, 2);
    builder.addGap();
    builder.add(new CheckBox("Confidential"), 3);
    ...
    builder.addLabel("Deadline:", 1);
    builder.add(deadline, 2);
    builder.addGap();
    builder.add(new CheckBox("Not related to work"), 3);
    ...
    builder.addLabel("Duration:", 1);
    builder.add(duration, 2);
    builder.addGap();
    builder.addSeparator("Priority", 3);
    ...
    builder.add(priority, 3);

    // row #8

    builder.addSeparator("Completion status", 7);

    // row #9

    builder.addLabel("Percentage Complete", 5);
