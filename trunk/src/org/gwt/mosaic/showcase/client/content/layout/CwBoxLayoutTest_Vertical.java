...
public class CwBoxLayoutTest_Vertical extends ContentWidget {
   ...
   */
  public CwBoxLayoutTest_Vertical(CwConstants constants) {
    super(constants);
  }

  @Override
  public String getDescription() {
    return "Vertical BoxLayout Test (with scrollbar)";
  }
