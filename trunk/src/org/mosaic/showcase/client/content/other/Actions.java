 ...
 * the License.
 */
package org.mosaic.showcase.client.content.other;

import org.mosaic.actions.client.Action;
import org.mosaic.actions.client.ActionListener;
import org.mosaic.actions.client.ActionRegistry;
...
public class Actions extends Page {
   ...
   */
  public Actions(DemoConstants constants) {
    super(constants);
