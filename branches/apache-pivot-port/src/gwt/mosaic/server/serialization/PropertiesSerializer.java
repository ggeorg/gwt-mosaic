 ...
 */
package gwt.mosaic.server.serialization;

import gwt.mosaic.client.collections.Map;
import gwt.mosaic.client.collections.adapter.MapAdapter;
...
public class PropertiesSerializer implements Serializer<Map<?, ?>> {
	 ...
	 * 
	 * @param object
	 *            An instance of {@link Map} containing the data to be written
	 *            to the properties file. Keys must be strings, and values will
	...
	@Override
	public void writeObject(Map<?, ?> object, OutputStream outputStream)
