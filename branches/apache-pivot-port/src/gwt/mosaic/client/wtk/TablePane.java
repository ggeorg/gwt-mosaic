...
public class TablePane extends Container {
	...
	public static class Row implements Sequence<Component>, Iterable<Component> {
		 ...
		 * 
		 * @param relative
		 *            <tt>true</tt> if the row height is relative,
		 ...
		 * 
		 * @param highlighted
		 *            <tt>true</tt> to set the row as highlighted,
	...
	public static class Column {
		 ...
		 * 
		 * @param highlighted
		 *            <tt>true</tt> to set the column as highlighted,
		 *            <tt>false</tt> to set it as not highlighted
		 */
		public void setHighlighted(boolean highlighted) {
			if (highlighted != this.highlighted) {
	...
	public static void setRowSpan(Component component, int rowSpan) {
		Integer previousValue = (Integer) component.setAttribute(
				Attribute.ROW_SPAN, rowSpan);
	...
	public static void setColumnSpan(Component component, int columnSpan) {
		Integer previousValue = (Integer) component.setAttribute(
				Attribute.COLUMN_SPAN, columnSpan);
