...
public class CheckboxUI extends ButtonBase implements HasName, HasValue<Boolean> {
	...
	public CheckboxUI(Element elem) {
		super(elem);
		...
		// element appears in tab sequence. FocusWidget's setElement method
		// already calls setTabIndex, which is overridden below. However, at
		// the time that this call is made, inputElem has not been created.
		// So, we have to call setTabIndex again, once inputElem has been
		// created.
		setTabIndex(0);
	}
	...
	public HandlerRegistration addValueChangeHandler(
		...
		// Is this the first value change handler? If so, time to add
		// handlers
	...
	protected void ensureDomEventHandlers() {
		addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				ValueChangeEvent.fire(CheckboxUI.this, getValue());
			}
		});
	}
