...
public interface Bindable {
	 ...
	 * 
	 * @param namespace
	 *            The serializer's namespace. The bindable object can use this
	 *            to extract named values defined in the BXML file.
	 *            Alternatively, the {@link BXML} annotation can be used by
	 *            trusted code to automatically map namespace values to member
	 *            variables.
	 * 
	 * @param location
	 *            The location of the BXML source. May be <tt>null</tt> if the
	 *            location of the source is not known.
	 * 
	 * @param resources
	 *            The resources that were used to localize the deserialized
