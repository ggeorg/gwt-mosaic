...
public interface Dictionary<K, V> extends Serializable {
	...
	public static final class Pair<K, V> implements Serializable {
		...
		public boolean equals(Object object) {
			...
			if (object instanceof Pair<?, ?>) {
				...
				equals = (key.equals(pair.key) && ((value == null && pair.value == null) || (value != null && value
						.equals(pair.value))));
			}
	 ...
	 *         not exist. Will also return null if the key refers to a null
	 *         value. Use <tt>containsKey()</tt> to distinguish between these
	 *         two cases.
	 */
	public V get(K key);
