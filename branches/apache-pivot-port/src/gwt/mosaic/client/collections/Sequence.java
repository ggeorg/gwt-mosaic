...
public interface Sequence<T> {
	...
	public static class Tree<T> {
		...
		public interface ItemIterator<T> extends Iterator<T> {
			 ...
			 *             If <tt>next()</tt> has not yet been called on this
			 *             iterator.
			 */
			public Path getPath();
		}

		private static class DepthFirstItemIterator<T> implements
				ItemIterator<T> {
		 ...
		 * 
		 * @param path
		 *            The path of the sequence to which the item should be
		 *            added.
		 * 
		 ...
		 * 
		 * @param path
		 *            The path of the sequence into which the item should be
		 *            inserted.
		 * 
		 * @param index
		 *            The index at which the item should be inserted within the
		 *            parent sequence.
		 */
		@SuppressWarnings("unchecked")
		 ...
		 * 
		 * @param item
		 *            The item that will replace any existing value at the given
		 *            path.
		 * 
		...
		public static <T> Path remove(Sequence<T> sequence, T item) {
			...
			if (path == null) {
				throw new IllegalArgumentException(
						"item is not a descendant of sequence.");
			}
		 ...
		 */
		@SuppressWarnings("unchecked")
		public static <T> Sequence<T> remove(Sequence<T> sequence, Path path,
				int count) {
			if (sequence == null) {
				throw new IllegalArgumentException("sequence is null.");
			}
		 ...
		 * nested sequence.
		 */
		public static <T> ItemIterator<T> depthFirstIterator(
				Sequence<T> sequence) {
		 ...
		 */
		public static boolean isDescendant(Path ancestorPath,
				Path descendantPath) {
	 ...
	 * 
	 * @param index
	 *            The index at which the item should be inserted. Must be a
