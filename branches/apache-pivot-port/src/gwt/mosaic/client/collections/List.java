...
public interface List<T> extends Sequence<T>, Collection<T> {
	 ...
	 * List listener list.
	 */
	public static class ListListenerList<T> extends
			ListenerList<ListListener<T>> implements ListListener<T> {
		@Override
	 ...
	 *             If the list is sorted and the insertion point of the item
	 *             does not match the given index.
	 * 
	 ...
	 * 
	 * @throws IllegalArgumentException
	 *             If the list is sorted and the index of the updated item would
	 *             be different than its current index.
	 * 
	 ...
	 *         not known. In this case, the iterator must be used to retrieve
