...
/**
 * Tests for {@link DecoratedLayoutPopupPanel}
 * 
 * @author georgopoulos.georgios(at)gmail.com
 * 
 */
@DoNotRunWith(Platform.HtmlUnit)
public class DecoratedLayoutPopupPanelTest extends GWTTestCase {

  private static class Adder implements HasWidgetsTester.WidgetAdder {
    public void addChild(HasWidgets container, Widget child) {
      ((DecoratedLayoutPopupPanel) container).setWidget(child);
    }
  }
   ...
   */
  private static class TestablePopupPanel extends DecoratedLayoutPopupPanel {
  ...
  public void testAccessors() {
    DecoratedLayoutPopupPanel popup = createPopupPanel();
  ...
  /**
   * @return a new {@code DecoratedLayoutPopupPanel}
   */
  ...
  public void testAutoHidePartner() {
    final DecoratedLayoutPopupPanel popup = createPopupPanel();
  ...
  public void testDependantPopupPanel() {
    ...
    final DecoratedLayoutPopupPanel dependantPopup = createPopupPanel();
    dependantPopup.setAnimationEnabled(true);

    // Create the primary popup
    final DecoratedLayoutPopupPanel primaryPopup = new DecoratedLayoutPopupPanel(false, false) {
      @Override
   ...
   */
  protected void testDependantPopupPanel(final DecoratedLayoutPopupPanel primaryPopup) {
    // Show the popup
    primaryPopup.show();
