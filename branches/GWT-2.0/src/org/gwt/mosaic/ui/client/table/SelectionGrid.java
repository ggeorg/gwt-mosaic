...
import org.gwt.mosaic.override.client.Grid;
import org.gwt.mosaic.override.client.OverrideDOM;
import org.gwt.mosaic.ui.client.event.CellHighlightEvent;
import org.gwt.mosaic.ui.client.event.CellHighlightHandler;
import org.gwt.mosaic.ui.client.event.CellUnhighlightEvent;
import org.gwt.mosaic.ui.client.event.CellUnhighlightHandler;
import org.gwt.mosaic.ui.client.event.HasCellHighlightHandlers;
import org.gwt.mosaic.ui.client.event.HasCellUnhighlightHandlers;
import org.gwt.mosaic.ui.client.event.HasRowHighlightHandlers;
import org.gwt.mosaic.ui.client.event.HasRowSelectionHandlers;
import org.gwt.mosaic.ui.client.event.HasRowUnhighlightHandlers;
...
import org.gwt.mosaic.ui.client.event.UnhighlightEvent;
import org.gwt.mosaic.ui.client.event.UnhighlightHandler;
...
/**
 * A variation of the GWT {@code Grid} that supports row or cell highlight and
 * row selection.
 * 
...
public class SelectionGrid extends Grid implements HasRowHighlightHandlers,
  ...
  protected void fireRowSelectionEvent(Set<Row> oldRowSet) {
    ...
    RowSelectionEvent.fire(this, oldRowSet, newRowList);
  }
