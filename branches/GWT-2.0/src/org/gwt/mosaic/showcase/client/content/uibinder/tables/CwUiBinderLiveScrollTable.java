...
public class CwUiBinderLiveScrollTable extends ContentWidget {
  interface Binder extends UiBinder<Widget, CwUiBinderLiveScrollTable> {
  }
   ...
   */
  public CwUiBinderLiveScrollTable(CwConstants constants) {
    super(constants);
  }

  @Override
  public String getDescription() {
    return "UiBinder LiveScrollTable description";
  }

  @Override
  public String getName() {
    return "LiveScrollTable";
  }
  ...
  protected Widget onInitialize() {
    ...
    List<Student> students = StudentGenerator.generate(500);
