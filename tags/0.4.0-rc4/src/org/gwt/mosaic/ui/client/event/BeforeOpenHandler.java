...
/**
 * Handler interface for {@link BeforeOpenEvent} events.
 * 
...
public interface BeforeOpenHandler<T> extends EventHandler {
  ...
  /**
   * Called when {@link BeforeOpenEvent} is fired.
   * 
   * @param event the {@link BeforeOpenEvent} that was fired
   */
  void onBeforeOpen(BeforeOpenEvent<T> event);
}
